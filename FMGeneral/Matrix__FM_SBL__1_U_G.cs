...
namespace FMGeneral
{
    ...
    public class Matrix__FM_SBL__1_U_G : B1Item
    {
        public Matrix__FM_SBL__1_U_G()
        {
            FormType = "FM_SBL";
            ItemUID = "1_U_G";
        }
        ...
        public virtual void OnAfterValidate(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.InnerEvent == false)
                {
                    ...
                    var with1 = form.DataSources.DBDataSources.Item("@FM_SBL2");
                            ...
                            case "C_1_1":
                                {
                                    ...
                                    if (LastItem != "")
                                    {
                                        TMatrix.addRow(form, "1_U_G", "#", "@FM_SBL2");
