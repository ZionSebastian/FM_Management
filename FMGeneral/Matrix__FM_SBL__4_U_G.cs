...
namespace FMGeneral
{
    ...
    public class Matrix__FM_SBL__4_U_G : B1Item
    {
        public Matrix__FM_SBL__4_U_G()
        {
            FormType = "FM_SBL";
            ItemUID = "4_U_G";
        }
        ...
        public virtual bool OnBeforeRightClick(ContextMenuInfo pVal)
        {
            ...
            Item item = form.Items.Item("4_U_G");
        ...
        public virtual void OnAfterValidate(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.InnerEvent == false)
                {
                    ...
                    var with1 = form.DataSources.DBDataSources.Item("@FM_SBL5");

                    SAPbouiCOM.Matrix oMat = (SAPbouiCOM.Matrix)form.Items.Item("4_U_G").Specific;
                            ...
                            case "C_4_1":
                                {
                                    ...
                                    if (LastItem != "")
                                    {
                                        TMatrix.addRow(form, "4_U_G", "#", "@FM_SBL5");
                                        TMatrix.RefreshRowNo(form, "4_U_G", "#");
                                        matrix.Columns.Item("C_4_2").Cells.Item(pVal.Row).Click();
                                    }
                                    break;
                                }
