...
namespace FMGeneral
{
    ...
    public class Matrix__FM_SBL__0_U_G : B1Item
    {
        public Matrix__FM_SBL__0_U_G()
        {
            FormType = "FM_SBL";
            ItemUID = "0_U_G";
        }
        ...
        public virtual void OnAfterValidate(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.InnerEvent == false)
                {
                    ...
                    var with1 = form.DataSources.DBDataSources.Item("@FM_SBL1");
                            ...
                            case "C_0_1":
                                {
                                    ...
                                    if (LastItem != "")
                                    {
                                        TMatrix.addRow(form, "0_U_G", "#", "@FM_SBL1");
                                ...
                                //        matrix.FlushToDataSource();
                                //        int lastrow = matrix.VisualRowCount;
                                //        string LastItem = with1.GetValue("U_RwMtrlCode", lastrow - 1).ToString().Trim();
                                //        if (LastItem != "")
                                //        {
                                //            TMatrix.addRow(form, "0_U_G", "#", "@FM_SBL1");
                                //            TMatrix.RefreshRowNo(form, "0_U_G", "#");
