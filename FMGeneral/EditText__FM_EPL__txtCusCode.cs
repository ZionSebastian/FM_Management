...
namespace FMGeneral
{
    ...
    public class EditText__FM_EPL__txtCusCode : B1Item
    {
        public EditText__FM_EPL__txtCusCode()
        {
            FormType = "FM_EPL";
            ItemUID = "txtCusCode";
        }
        ...
        public virtual bool OnBeforeChooseFromList(ItemEvent pVal)
        {
            ...
            Item item = form.Items.Item("txtCusCode");
            ...
            try
            {
                ...
                Conds = TConditions.Create("CardType", "C", BoConditionOperation.co_EQUAL);
        ...
        public virtual void OnAfterChooseFromList(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.ActionSuccess)
                {
                    ...
                    var _with_FM_OMHF = form.DataSources.DBDataSources.Item("@FM_OEPL");
                    dataTableCFL = TChooseFromList.GetValue(pVal, form);

                    if (dataTableCFL != null)
                    {
                        _with_FM_OMHF.SetValue("U_CustCode", 0, dataTableCFL.GetValue("CardCode", 0).ToString().Trim());
