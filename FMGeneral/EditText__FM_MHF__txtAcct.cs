...
namespace FMGeneral
{
    ...
    public class EditText__FM_MHF__txtAcct : B1Item
    {
        public EditText__FM_MHF__txtAcct()
        {
            FormType = "FM_MHF";
            ItemUID = "txtAcct";
        }
        ...
        public virtual bool OnBeforeChooseFromList(ItemEvent pVal)
        {
            ...
            Item item = form.Items.Item("txtAcct");
        ...
        public virtual void OnAfterChooseFromList(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.ActionSuccess)
                {
                    ...
                    {
                        _with_FM_OMHF.SetValue("U_GLAcct", 0, dataTableCFL.GetValue("AcctCode", 0).ToString().Trim());
