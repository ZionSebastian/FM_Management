...
namespace FMGeneral
{
    ...
    public class Matrix__FM_SBL__3_U_G : B1Item
    {
        public Matrix__FM_SBL__3_U_G()
        {
            FormType = "FM_SBL";
            ItemUID = "3_U_G";
        }
        ...
        public virtual bool OnBeforeRightClick(ContextMenuInfo pVal)
        {
            ...
            Item item = form.Items.Item("3_U_G");
        ...
        public virtual void OnAfterValidate(ItemEvent pVal)
        {
            ...
            try
            {
                if (pVal.InnerEvent == false)
                {
                    ...
                    var with1 = form.DataSources.DBDataSources.Item("@FM_SBL4");

                    SAPbouiCOM.Matrix oMat = (SAPbouiCOM.Matrix)form.Items.Item("3_U_G").Specific;
                            ...
                            case "C_3_1":
                                {
                                    ...
                                    if (LastItem != "")
                                    {
                                        TMatrix.addRow(form, "3_U_G", "#", "@FM_SBL4");
                                        TMatrix.RefreshRowNo(form, "3_U_G", "#");
                                        matrix.Columns.Item("C_3_2").Cells.Item(pVal.Row).Click();
                                    }
                                    break;
                                }
