...
{
    using Class_Files;
    public class Button__FM_RPD__btnPrint : B1Item
    {
        public Button__FM_RPD__btnPrint()
        {
            FormType = "FM_RPD";
            ItemUID = "btnPrint";
        }
        ...
        public virtual bool OnBeforeItemPressed(ItemEvent pVal)
        {
            ...
            try
            {
                if (form.Mode == BoFormMode.fm_OK_MODE)
                {
                    ...
                    var _with1 = form.DataSources.DBDataSources.Item("@FM_RPD1");
        ...
        public virtual void OnAfterItemPressed(ItemEvent pVal)
        {
            ...
            try
            {
                ...
                globalvariables.RPDPrintDocEntry = sDocEntry;
                ...
                string printDocEntry = globalvariables.RPDPrintDocEntry;

                globalvariables.CRSPrint = true;
                globalvariables.PrintType = "FM_RPD";

                SAPbobsCOM.Recordset RS = null;

                string MenuUID = TSQL.GetSingleRecord("Select \"MenuUID\"  from OCMN where \"ObjectKey\" = (Select \"U_Values\" From \"@CCS_EPLSETT\" Where \"Code\" = '2')");
