            ...
            try
            {
                switch (_form.TypeEx)
                {
                    ...
                    case "FM_BER":
                        ...
                        BankSQL += "WHEN T1.AcctCode = '125219' THEN 'DEBIT CARD-15.001 BENGUELA' WHEN T1.AcctCode = '125220' THEN 'DEBIT CARD-15.002 OFFICE' WHEN T1.AcctCode = '124510' THEN 'BFA SHORT TERM LOAN-OD FACILTY' WHEN T1.AcctCode = '124514' THEN 'CAIXA SHORT TERM LOAN-OD FACILTY'  WHEN T1.AcctCode='124519' THEN 'CAIXA RESERVE' END AS[AccountName] ";
                        ...
                        BankSQL += "WHEN T1.AcctCode = '125219' THEN '17' WHEN T1.AcctCode = '125220' THEN '18' WHEN T1.AcctCode = '124510' THEN '19' WHEN T1.AcctCode = '124514' THEN '20'  WHEN T1.AcctCode='124519' THEN '21'END AS[AccountOrder] ";

                        BankSQL += " FROM OACT T1 WHERE T1.AcctCode in ('124101', '124201', '124202', '124204', '124205', '124206', '124207', '124211', '124404', '124213', '124214', '124215', '124216', '124102', '124500', '124507', '124516', '124521', '124104', '124708','125216','125217','125218','125219','125220', '124510', '124514', '124519') )A order by cast([AccountOrder] as numeric)";
